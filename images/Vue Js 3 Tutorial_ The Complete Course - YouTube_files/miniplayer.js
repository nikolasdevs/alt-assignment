(function(g){var window=this;'use strict';var Lpb=function(a,b){g.W.call(this,{I:"button",Ma:["ytp-miniplayer-expand-watch-page-button","ytp-button","ytp-miniplayer-button-top-left"],W:{title:"{{title}}","data-tooltip-target-id":"ytp-miniplayer-expand-watch-page-button","aria-keyshortcuts":"i","data-title-no-tooltip":"{{data-title-no-tooltip}}"},V:[{I:"svg",W:{height:"24px",version:"1.1",viewBox:"0 0 24 24",width:"24px"},V:[{I:"g",W:{fill:"none","fill-rule":"evenodd",stroke:"none","stroke-width":"1"},V:[{I:"g",W:{transform:"translate(12.000000, 12.000000) scale(-1, 1) translate(-12.000000, -12.000000) "},
V:[{I:"path",W:{d:"M19,19 L5,19 L5,5 L12,5 L12,3 L5,3 C3.89,3 3,3.9 3,5 L3,19 C3,20.1 3.89,21 5,21 L19,21 C20.1,21 21,20.1 21,19 L21,12 L19,12 L19,19 Z M14,3 L14,5 L17.59,5 L7.76,14.83 L9.17,16.24 L19,6.41 L19,10 L21,10 L21,3 L14,3 Z",fill:"#fff","fill-rule":"nonzero"}}]}]}]}]});this.J=a;this.Sa("click",this.onClick,this);this.updateValue("title",g.HU(a,"Expand","i"));this.update({"data-title-no-tooltip":"Expand"});g.Db(this,g.BU(b.Dc(),this.element))},Mpb=function(a){g.W.call(this,{I:"div",
S:"ytp-miniplayer-ui"});this.pg=!1;this.player=a;this.T(a,"minimized",this.Ch);this.T(a,"onStateChange",this.vR)},Npb=function(a){g.uV.call(this,a);
this.B=new g.MK(this);this.j=new Mpb(this.player);this.j.hide();g.nU(this.player,this.j.element,4);a.rg()&&(this.load(),g.Gu(a.getRootNode(),"ytp-player-minimized",!0))};
g.x(Lpb,g.W);Lpb.prototype.onClick=function(){this.J.Ra("onExpandMiniplayer")};g.x(Mpb,g.W);g.k=Mpb.prototype;
...
g.k.Lu=function(){};
g.k.Ls=function(){};
g.k.aF=function(){};g.x(Npb,g.uV);g.k=Npb.prototype;g.k.onVideoDataChange=function(){if(this.player.getVideoData()){var a=this.player.getVideoAspectRatio(),b=16/9;a=a>b+.1||a<b-.1;g.Gu(this.player.getRootNode(),"ytp-rounded-miniplayer-not-regular-wide-video",a)}};
...
g.k.unload=function(){this.player.showControls();this.j.hide()};g.tV("miniplayer",Npb);})(_yt_player);
